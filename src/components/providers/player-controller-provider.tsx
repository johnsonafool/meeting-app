...
// player controller context provider
interface JoyStickControllerContextProps {
  forward: boolean;
  backward: boolean;
  left: boolean;
  right: boolean;
...
const JoyStickControllerContext = createContext<JoyStickControllerContextProps>(
  {
    forward: false,
    backward: false,
    left: false,
